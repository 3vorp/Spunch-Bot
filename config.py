...
# used in feedback and help embeds for who to report or suggest stuff to
DEVELOPER = 'Evorp#5819'

# this is just a hex color code (#C3BA5C) with 0x in front of it so discord parses it as hex, as the name implies it's used on basically all embeds
...
# all of these are channel ids for various hardcoded things like startup messages, where to push global announcements from, and where suggestions should go
